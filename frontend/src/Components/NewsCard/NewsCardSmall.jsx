...
function NewsCardSmall({ startIndex, endIndex, heading, className, category, cardLimit, negativeTags, omitLimit }) {
        ...
        {limitedNews.map((news, index) => {
          ...
          return (
            <div key={index} className={styles.card}>
              <Link to={`/${news.category}/${news.id}`} style={{ textDecoration: 'none', color: 'inherit', width:'100%' }}>
                ...
                <div className={styles['news-card-content']}
                  ...
                  <div className={styles['img-div']}>
                    <img src={news.thumbnailUrl || AltImageSmall} alt="news" />
                  </div>
