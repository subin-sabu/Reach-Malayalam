...
import { Grid, Paper, CardContent, Typography, Box, CardMedia, IconButton, Link as MuiLink } from '@mui/material';
        ...
        {(newsItem.heading1 || newsItem.description1) &&
          <CardContent onCopy={handleCopy} sx={{ height: '100%', display: 'flex', flexDirection: 'column', paddingTop: '0.5rem' }}>
            ...
            {newsItem.description1 &&
              <Typography variant="body1" fontWeight={10} sx={{ overflow: 'hidden', textOverflow: 'ellipsis', display: 'flex', flexDirection: 'column' }}>
        ...
        {(newsItem.heading2 || newsItem.description2) &&
          <CardContent onCopy={handleCopy} sx={{ height: '100%', display: 'flex', flexDirection: 'column', paddingTop: '0.5rem' }}>
            ...
            {newsItem.description2 &&
              <Typography variant="body1" fontWeight={10} sx={{ overflow: 'hidden', textOverflow: 'ellipsis', display: 'flex', flexDirection: 'column' }} component="div">
