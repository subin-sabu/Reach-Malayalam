...
import { db, storage } from '../../firebase/config'; //  db is correctly initialized in config file
    ...
    <div>
      ...
      <Container>
        <form onSubmit={handleSubmit}>
          ...
          <Typography variant="subtitle1" component="div" sx={{ color: 'info.main' }}>↓ Add 'main' tag to display as main news</Typography>
          ...
          <FormControl component="fieldset" margin="normal">
            ...
            <>
              {imagePreview1 && (
                <>
                  <img src={imagePreview1} alt="Preview" style={{ height: 100, width: 'auto', margin: '10px 0' }} />
          ...
          <FormControl component="fieldset" margin="normal">
            ...
            <>
              {imagePreview2 && (
                <>
                  <img src={imagePreview2} alt="Preview" style={{ height: 100, width: 'auto', margin: '10px 0' }} />
          ...
          <FormControl component="fieldset" margin="normal">
            ...
            <>
              {imagePreview3 && (
                <>
                  <img src={imagePreview3} alt="Preview" style={{ height: 100, width: 'auto', margin: '10px 0' }} />
